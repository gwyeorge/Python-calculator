...
class calculator:
    def __init__(self):
        ...
        self.window.iconbitmap("main/images/favicon.ico")
        # self.window.iconbitmap("C:\Users\george\repositories\Python-calculator\main\images\favicon.ico")s
    ...
    def label(self):
        self.txtDisplay_image = PhotoImage(file="main/images/search.png")
    ...
    def general_buttons(self):
        self.backspace_image = PhotoImage(file="main/images/backspace.png")
        ...
        self.division_image = PhotoImage(file="main/images/division.png")
        ...
        self.clear_image = PhotoImage(file="main/images/clear.png")
        ...
        self.root_image = PhotoImage(file="main/images/root.png")
        ...
        self.e_image = PhotoImage(file="main/images/e.png")
        ...
        self.parentheses_image = PhotoImage(file="main/images/).png")
    ...
    def trigonometry_buttons(self):
        ...
        self.tan_image = PhotoImage(file="main/images/tan.png")
        ...
        self.sin_image = PhotoImage(file="main/images/sin.png")
        ...
        self.cos_image = PhotoImage(file="main/images/cos.png")
    ...
    def logarithmic_buttons(self):
        self.log_image = PhotoImage(file="main/images/log.png")
        ...
        self.ln_image = PhotoImage(file="main/images/ln.png")
    ...
    def numbers_buttons(self):
        ...
        self.number9_image = PhotoImage(file="main/images/numbers/number9.png")
        ...
        self.number6_image = PhotoImage(file="main/images/numbers/number6.png")
        ...
        self.number3_image = PhotoImage(file="main/images/numbers/number3.png")
        ...
        self.number8_image = PhotoImage(file="main/images/numbers/number8.png")
        ...
        self.number5_image = PhotoImage(file="main/images/numbers/number5.png")
        ...
        self.number2_image = PhotoImage(file="main/images/numbers/number2.png")
        ...
        self.number7_image = PhotoImage(file="main/images/numbers/number7.png")
        ...
        self.number4_image = PhotoImage(file="main/images/numbers/number4.png")
        ...
        self.number1_image = PhotoImage(file="main/images/numbers/number1.png")
        ...
        self.number0_image = PhotoImage(file="main/images/numbers/number0.png")
